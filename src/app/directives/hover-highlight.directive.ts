...
//elementRef allows us to access the native DOM element assoiciated with the directive
  ...
  /*
  @HostListener('mouseenter'): This method is triggered when the mouse enters the element. It calls the
  highlight method, passing in
  either the color specified in appHoverHighlight or a default color of yellow if none is provided.
  @HostListener('mouseleave'): This method is triggered when the mouse leaves the element. It calls the
  highlight method with an
